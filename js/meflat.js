$(document).ready(function() {
	...
	$('.project-item').click(function(e){
		e.preventDefault();
		var typeOfProj = $(this).attr('class');
		...
		$('#project-modal').on('show.bs.modal', function () {
			...
			if(typeOfProj.indexOf('graphic') != -1){
				$(this).find('.img-responsive').attr('src',"assets/window.png");
				console.log("found");
			}
			else{
				$(this).find('.img-responsive').attr('src',"assets/chrome.png");
			}
